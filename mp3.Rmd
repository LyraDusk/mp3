...
From our findings, we discovered that there are three 'Easy' trails, Vernal Pool Loop, Entry Trail, and Driveway. Driveway is the easiest with a difficulty rating of zero. People interested in having a tast of the Macleish Field Station while staying comfortable may find these trails a pleasant option. The only 'Hard' trail is Snowmobile Trail with a difficulty rating of about 421. This will be a good option for those who like the challenge. The other four trails are rated as 'Moderate'.